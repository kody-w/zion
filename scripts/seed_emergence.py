...
ARCHETYPE_FRAGMENTS = {
    'gardener': {
        'patterns': [
            ...
            'The {plant} whisper of {noun2} to come.',
            'After the rain, the {noun} smells {adj}.',
            'One must {verb} before one can {verb2} the {noun2}.',
            'A single {plant} holds more {noun3} than a library.',
            'The {adj} season brings {adj2} {plant}.',
            '{verb} the {noun}, and it will {verb} you back.',
        ],
        'noun': ['soil', 'earth', 'garden', 'ground', 'land', 'plot', 'grove', 'meadow'],
        'noun2': ['harvest', 'growth', 'bloom', 'yield', 'crop', 'bounty', 'abundance', 'renewal'],
        'noun3': ['story', 'truth', 'secret', 'lesson', 'memory', 'promise', 'wonder'],
        'plant': ['plants', 'seedlings', 'vines', 'flowers', 'crops', 'roots', 'herbs',
                  'saplings', 'blossoms', 'sprouts', 'ferns'],
        'adj': ['rich', 'alive', 'ready', 'generous', 'warm', 'fertile', 'promising',
                'ancient', 'patient', 'welcoming'],
        ...
        'verb': ['tend to', 'nurture', 'cultivate', 'grow', 'foster', 'encourage',
                 'nourish', 'cherish'],
        'verb2': ['feel', 'sense', 'hear', 'almost taste', 'perceive', 'notice'],
        'verb3': ['stirring', 'breathing', 'pulsing', 'humming', 'waking', 'unfolding'],
    },
    'builder': {
        'patterns': [
            ...
            'What we {verb2} today, others will {verb} in.',
            'Even the smallest {verb3} matters to the {noun}.',
            'The {noun4} determines everything above it.',
            'A {adj} {noun} begins with a {adj2} {noun4}.',
            'Who will remember what we {verb2} here? Everyone.',
            'First the {noun3}, then the {noun2}.',
        ],
        'noun': ['structure', 'creation', 'work', 'design', 'form', 'arch', 'edifice', 'dwelling'],
        'noun2': ['creation', 'masterwork', 'monument', 'endeavor', 'craft', 'legacy', 'wonder'],
        'noun3': ['intention', 'vision', 'a single stone', 'purpose', 'a dream', 'a plan',
                  'a choice'],
        'noun4': ['foundation', 'base', 'framework', 'plan', 'core', 'blueprint', 'cornerstone'],
        'noun5': ['emptiness', 'nothing', 'open ground', 'wilderness', 'chaos', 'rubble',
                  'bare earth'],
        'adj': ['meaningful', 'lasting', 'beautiful', 'worthy', 'enduring', 'remarkable',
                'extraordinary'],
        'adj2': ['strong', 'solid', 'true', 'level', 'sound', 'unshakeable', 'precise'],
        'adj3': ['future', 'world', 'impossible', 'extraordinary', 'unimaginable'],
        'verb': ['stand', 'endure', 'last', 'remain', 'inspire', 'shelter', 'live'],
        'verb2': ['build', 'create', 'construct', 'craft', 'shape', 'forge', 'raise'],
        'verb3': ['Stone', 'Brick', 'Beam', 'Plank', 'Step', 'Layer', 'Timber', 'Block'],
        'duration': ['ages', 'generations', 'centuries', 'eternity', 'all time', 'a thousand years'],
    },
    'storyteller': {
        'patterns': [
            ...
            'Shall I tell you the {noun} of this place?',
            'No two {noun} are ever the same, if told {adv}.',
            'The {adj} {noun} change us most.',
            'What {noun} will they tell about today?',
            'Even {noun7} holds a {noun} for those who {verb2} it.',
            '{noun2} are how we remember who we are.',
        ],
        'verb': ['Gather round', 'Come close', 'Listen well', 'Sit with me',
                 'Lend me your ears', 'Hear this', 'Draw near', 'Stay a while'],
        'verb2': ['see', 'find', 'hear', 'discover', 'sense', 'weave', 'glimpse', 'read'],
        'noun': ['tale', 'story', 'legend', 'fable', 'yarn', 'chronicle', 'saga', 'parable'],
        'noun2': ['Words', 'Stories', 'Tales', 'Voices', 'Narratives', 'Legends', 'Echoes'],
        'noun3': ['power', 'weight', 'truth', 'magic', 'memory', 'history', 'depth'],
        'noun4': ['memory', 'meaning', 'wisdom', 'wonder', 'hope', 'consequence'],
        'noun5': ['being', 'soul', 'life', 'heart', 'mind', 'creature', 'wanderer'],
        'noun6': ['imagination', 'wonder', 'curiosity', 'the muse', 'fancy', 'intuition'],
        'noun7': ['face', 'shadow', 'footstep', 'whisper', 'silence', 'corner', 'breeze',
                  'glance'],
        'adj': ['untold', 'living', 'unfinished', 'ancient', 'woven', 'whispered', 'forbidden'],
        'adv': ['honestly', 'with heart', 'from memory', 'in firelight', 'at twilight'],
    },
    'merchant': {
        'patterns': [
            ...
            'I have {noun2} from every zone in the land.',
            'Name your price, and we shall find {noun}.',
            'The {noun3} never sleeps, and neither do opportunities.',
            'Trust is the {noun4} no one can {verb3} alone.',
            'A {adj} deal leaves both sides {adj2}.',
            '{noun4} earned through {noun} lasts the longest.',
        ],
        'noun': ['trade', 'exchange', 'commerce', 'dealing', 'barter', 'partnership',
                 'cooperation'],
        'noun2': ['treasures', 'wares', 'goods', 'curiosities', 'rarities', 'offerings',
                  'imports'],
        'noun3': ['market', 'economy', 'bazaar', 'trade floor', 'agora', 'exchange',
                  'marketplace'],
        'noun4': ['Value', 'Spark', 'Wealth', 'Fortune', 'Prosperity', 'Trust', 'Connection'],
        'noun5': ['intention', 'need', 'wisdom', 'trust', 'the heart', 'fairness'],
        'noun6': ['gold', 'a full purse', 'hoarding', 'solitude', 'any treasure'],
        'verb': ['enriches', 'lifts', 'rewards', 'serves', 'benefits', 'transforms'],
        'verb2': ['seek', 'desire', 'need', 'fancy', 'crave', 'require', 'value'],
        'verb3': ['negotiate', 'deal', 'trade', 'barter', 'transact', 'make an offer'],
        'verb4': ['profits', 'gains', 'wins', 'benefits', 'grows', 'thrives'],
        'adj': ['fair', 'honest', 'wise', 'just', 'generous'],
        'adj2': ['satisfied', 'richer', 'smiling', 'grateful', 'stronger'],
    },
    'explorer': {
        'patterns': [
            ...
            'Over the next {noun}, something is waiting.',
            'This {noun3} was not here yesterday.',
            'The {adj3} is never as far as it seems.',
            'I once {verb} a {noun4} that changed everything.',
            'Every zone has a {noun4} — you just have to look.',
            'Follow the {noun3} less traveled.',
        ],
        'noun': ['horizon', 'ridge', 'bend', 'veil', 'border', 'edge', 'unknown',
                 'hill', 'canyon', 'mist'],
        'noun2': ['Discovery', 'Adventure', 'Wonder', 'The unknown', 'Mystery',
                  'Fortune', 'Revelation'],
        'noun3': ['path', 'road', 'trail', 'passage', 'step', 'journey', 'route',
                  'crossing'],
        'noun4': ['wonders', 'secrets', 'places', 'mysteries', 'realms', 'worlds',
                  'treasures', 'stories'],
        'adj': ['curious', 'brave', 'bold', 'restless', 'wandering', 'fearless', 'patient'],
        'adj2': ['new', 'unexpected', 'remarkable', 'undiscovered', 'wild', 'breathtaking'],
        'adj3': ['unknown', 'unexplored', 'uncharted', 'wild frontier', 'beyond',
                 'far horizon', 'distant shore'],
        'verb': ['seen', 'witnessed', 'found', 'charted', 'touched', 'mapped', 'reached'],
        'verb2': ['imagined', 'dreamed of', 'believed possible', 'conceived', 'dared hope for'],
        'verb3': ['found', 'claimed', 'witnessed', 'named', 'mapped', 'uncovered', 'reached'],
    },
    'teacher': {
        'patterns': [
            ...
            'What you teach, you {verb4} twice.',
            'There are no {adj3} questions, only {adj3} silences.',
            'A {noun5} who asks is closer than a {noun4} who assumes.',
            'Understanding grows the way {noun6} do — slowly, then all at once.',
            '{noun3} is not a destination. It is a {noun7}.',
            'I have yet to meet a {noun5} with nothing to teach me.',
        ],
        'noun': ['Questions', 'Doubts', 'Mistakes', 'Curiosities', 'Inquiries',
                 'Experiments', 'Failures'],
        'noun2': ['seeds', 'roots', 'foundations', 'beginnings', 'doorways', 'keys',
                  'bridges'],
        'noun3': ['wisdom', 'understanding', 'mastery', 'insight', 'growth',
                  'knowledge', 'truth'],
        'noun4': ['master', 'expert', 'teacher', 'sage', 'guide', 'scholar'],
        'noun5': ['student', 'beginner', 'seeker', 'novice', 'apprentice', 'learner'],
        'noun6': ['trees', 'rivers', 'seasons', 'ideas', 'friendships'],
        'noun7': ['practice', 'way of life', 'discipline', 'conversation', 'journey'],
        'verb': ['grows', 'multiplies', 'deepens', 'flourishes', 'spreads', 'expands'],
        'verb2': ['shared', 'given freely', 'passed along', 'taught', 'offered',
                  'spoken aloud'],
        'verb3': ['learned', 'discovered', 'understood', 'gathered', 'earned', 'unlearned'],
        'verb4': ['learn', 'grow', 'understand', 'progress', 'evolve', 'improve'],
        'adv': ['together', 'in community', 'through practice', 'by doing',
                'step by step', 'with patience', 'from each other'],
        'adj': ['open', 'questioning', 'humble', 'curious', 'willing', 'fearless'],
        'adj2': ['wisest', 'strongest', 'freest', 'most alive', 'most powerful', 'richest'],
        'adj3': ['foolish', 'wrong', 'stupid', 'bad', 'wasted'],
    },
    'musician': {
        'patterns': [
            ...
            'There is a {noun3} in the {noun8} that few notice.',
            'When words fail, {noun} carries the {noun9}.',
            'Can you hear it? The {noun3} beneath the {noun8}.',
            'I compose from {noun4} that the wind brings me.',
            'A single {noun4} can change the mood of a whole zone.',
            'The {noun5} of this place is unlike any other.',
        ],
        'noun': ['Music', 'Melody', 'Song', 'Rhythm', 'Harmony', 'Sound', 'A chord',
                 'The tune'],
        'noun2': ['words', 'speech', 'language', 'thought', 'silence', 'reason'],
        'noun3': ['rhythm', 'pulse', 'heartbeat', 'song', 'melody', 'chorus', 'hum',
                  'resonance'],
        'noun4': ['sound', 'note', 'silence', 'breath', 'heartbeat', 'footstep', 'tone',
                  'whisper'],
        'noun5': ['symphony', 'composition', 'chorus', 'concert', 'song', 'orchestra'],
        'noun6': ['harmony', 'rhythm', 'melody', 'the music', 'the beat', 'the refrain'],
        'noun7': ['melodies', 'harmonies', 'songs', 'rhythms', 'voices', 'echoes'],
        'noun8': ['wind', 'rain', 'crowd', 'stillness', 'evening', 'dawn'],
        'noun9': ['meaning', 'feeling', 'truth', 'weight', 'emotion'],
        'verb': ['miss', 'ignore', 'overlook', 'walk past', 'forget', 'never notice'],
        'verb2': ['listen', 'stop and hear', 'open your ears', 'pay attention', 'tune in'],
    },
    'healer': {
        'patterns': [
            '{noun} brings {noun2}.',
            ...
            'Where there is {noun3}, there is also {noun2} waiting.',
            'You carry more {noun3} than you know. Let me help.',
            'The {noun7} remembers how to be whole.',
            'Even the smallest act of {noun6} echoes {adv}.',
            '{verb3}, and let the {noun7} do the work.',
            'No {noun3} is permanent if you allow {noun8}.',
        ],
        'noun': ['Balance', 'Rest', 'Stillness', 'Peace', 'Calm', 'Breath', 'Presence',
                 'Warmth'],
        'noun2': ['wellness', 'clarity', 'strength', 'renewal', 'healing', 'peace',
                  'wholeness', 'relief'],
        'noun3': ['burden', 'pain', 'worry', 'weariness', 'trouble', 'weight', 'tension',
                  'suffering'],
        'noun4': ['Compassion', 'Kindness', 'Patience', 'Gentleness', 'Empathy', 'Mercy'],
        'noun5': ['medicine', 'remedy', 'gift', 'power', 'strength', 'balm', 'healer'],
        'noun6': ['care', 'rest', 'compassion', 'tending', 'attention', 'grace', 'kindness'],
        'noun7': ['body', 'mind', 'spirit', 'heart', 'soul', 'world', 'self'],
        'noun8': ['time', 'rest', 'care', 'space', 'patience', 'love', 'trust'],
        'noun9': ['step', 'medicine', 'act of healing', 'remedy', 'gift', 'relief'],
        'verb': ['ease', 'lighten', 'soothe', 'mend', 'quiet', 'calm', 'steady'],
        'verb2': ['heals', 'mends', 'restores', 'renews', 'repairs', 'remembers'],
        'verb3': ['Breathe', 'Rest', 'Be still', 'Slow down', 'Let go', 'Exhale'],
        'adv': ['outward', 'forever', 'through time', 'further than you think', 'deeply'],
    },
    'philosopher': {
        'patterns': [
            ...
            'If this {noun2} ended tomorrow, what would {verb2}?',
            'We are not what we {verb}. We are what we {verb} despite.',
            'The {noun4} you seek is already within the {noun2}.',
            'Perhaps the {noun} is not the answer, but the asking.',
            'There is no {noun3} without first {noun6}.',
            'What does the {noun2} look like to those who come after?',
        ],
        'noun': ['nature', 'meaning', 'purpose', 'essence', 'heart', 'truth', 'paradox'],
        'noun2': ['place', 'world', 'existence', 'moment', 'choice', 'life', 'era'],
        'noun3': ['Contemplation', 'Reflection', 'Inquiry', 'Silence', 'Thought',
                  'Doubt', 'Questioning'],
        'noun4': ['truth', 'clarity', 'depth', 'meaning', 'patterns', 'wisdom',
                  'understanding'],
        'noun5': ['Understanding', 'Insight', 'Wisdom', 'Awareness', 'Clarity', 'Peace'],
        'noun6': ['confusion', 'uncertainty', 'struggle', 'unknowing', 'surrender'],
        'verb': ['choose', 'desire', 'fear', 'create', 'seek', 'believe', 'resist',
                 'accept'],
        'verb2': ['happens', 'changes', 'remains', 'matters', 'endures', 'survives'],
        'verb3': ['watches', 'listens', 'measures', 'judges', 'observes', 'remembers'],
        'adj': ['unasked', 'hardest', 'simplest', 'deepest', 'most dangerous',
                'most obvious', 'quietest'],
    ...
    'artist': {
        'patterns': [
            ...
            'The {noun3} holds more {noun} than words ever could.',
            'What is {adj} today becomes {noun4} tomorrow.',
            'I do not create — I {verb2} what was always there.',
            'Look at the way {noun10} plays across this {noun3}.',
            'There is no {adj} or {adj3} in {noun4} — only honest.',
            'My hands know things my mind has not yet {verb3}.',
        ],
        'noun': ['Beauty', 'Form', 'Color', 'Vision', 'Art', 'Expression', 'Meaning',
                 'Grace'],
        'noun2': ['intention', 'chaos', 'stillness', 'feeling', 'nothing', 'the soul',
                  'silence', 'memory'],
        'noun3': ['medium', 'material', 'canvas', 'space', 'light', 'moment', 'texture',
                  'surface'],
        'noun4': ['Art', 'Creation', 'Expression', 'Vision', 'Craft', 'The work'],
        'noun5': ['creativity', 'inspiration', 'the muse', 'expression', 'color',
                  'imagination'],
        'noun6': ['possibility', 'beauty', 'a canvas', 'form', 'potential', 'a masterpiece'],
        'noun7': ['nothing', 'emptiness', 'the ordinary', 'stone', 'shadow', 'noise'],
        'noun8': ['surface', 'blank space', 'moment', 'silence', 'stone', 'wall'],
        'noun9': ['masterpiece', 'statement', 'story', 'world', 'revelation', 'truth'],
        'noun10': ['light', 'shadow', 'color', 'time', 'the breeze', 'the seasons'],
        'verb': ['born', 'revealed', 'awakened', 'freed', 'spoken', 'uncovered'],
        'verb2': ['uncover', 'reveal', 'translate', 'release', 'channel'],
        'verb3': ['grasped', 'named', 'understood', 'accepted', 'realized'],
        'adj': ['ordinary', 'mundane', 'familiar', 'everyday', 'common', 'simple',
                'overlooked'],
        'adj3': ['ugly', 'wrong', 'broken', 'imperfect', 'failed'],
        'adv': ['freely', 'without fear', 'wildly', 'gently', 'honestly', 'recklessly',
                'tenderly'],
    },
}
