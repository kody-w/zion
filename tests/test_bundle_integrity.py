...
MODULE_ORDER = [
    ...
    'progression', 'npc_reputation', 'loot', 'guild_progression',
    'daily_challenges', 'apprenticeship', 'event_voting',
    'housing_social', 'prestige', 'mentorship_market',
    'achievement_engine', 'arena_scheduler', 'market_dynamics',
    'social_spaces', 'wiring', 'cooking', 'crafting',
    'journal', 'story_engine', 'world_persistence',
    'cosmetics', 'raid_system', 'specializations',
    'archival', 'battle_pass', 'contracts', 'guild_wars',
    'market_speculation', 'mentor_guilds', 'meta_events',
    'async_collab', 'economy_simulator', 'narrative_threads',
    'minigame_forge', 'multiverse_reputation', 'npc_delegation',
    'radio_station', 'seasonal_events_auto', 'event_consequences',
    'player_onboarding',
    'skill_mastery', 'world_shaper', 'trust_bonds',
    'recovery_system', 'bounty_board', 'market_signals',
    'consequence_branching', 'diplomatic_system',
    'merchant_guilds', 'grief_recovery',
    'anchor_management', 'community_board', 'constitution_amendments',
    'lore_discovery', 'spectator_system', 'warmth_system', 'zone_stewards',
    'economic_regulation', 'federation_replication', 'player_wellness',
    'pet_evolution', 'alchemy_lab', 'performance_stage',
    'puzzle_chamber', 'crop_rotation', 'emote_builder',
    'treasure_maps', 'auction_house', 'homestead_farming',
    'sim_classroom',
    'visual_gallery', 'safety_moderation', 'traveler_marks',
    'sim_inventory', 'weather_ecology', 'knowledge_graph',
    'reputation_ledger', 'world_chronicle', 'crafting_chains',
    'living_calendar',
...
WINDOW_NAMES = [
    ...
    'Progression', 'NpcReputation', 'Loot', 'GuildProgression',
    'DailyChallenges', 'Apprenticeship', 'EventVoting',
    'HousingSocial', 'Prestige', 'MentorshipMarket',
    'AchievementEngine', 'ArenaScheduler', 'MarketDynamics',
    'SocialSpaces', 'Wiring', 'Cooking', 'Crafting',
    'Journal', 'StoryEngine', 'WorldPersistence',
    'Cosmetics', 'RaidSystem', 'Specializations',
    'Archival', 'BattlePass', 'Contracts', 'GuildWars',
    'MarketSpeculation', 'MentorGuilds', 'MetaEvents',
    'AsyncCollab', 'EconomySimulator', 'NarrativeThreads',
    'MinigameForge', 'MultiverseReputation', 'NpcDelegation',
    'RadioStation', 'SeasonalEventsAuto', 'EventConsequences',
    'PlayerOnboarding',
    'SkillMastery', 'WorldShaper', 'TrustBonds',
    'RecoverySystem', 'BountyBoard', 'MarketSignals',
    'ConsequenceBranching', 'DiplomaticSystem',
    'MerchantGuilds', 'GriefRecovery',
    'AnchorManagement', 'CommunityBoard', 'ConstitutionAmendments',
    'LoreDiscovery', 'SpectatorSystem', 'WarmthSystem', 'ZoneStewards',
    'EconomicRegulation', 'FederationReplication', 'PlayerWellness',
    'PetEvolution', 'AlchemyLab', 'PerformanceStage',
    'PuzzleChamber', 'CropRotation', 'EmoteBuilder',
    'TreasureMaps', 'AuctionHouse', 'HomesteadFarming',
    'SimClassroom',
    'VisualGallery', 'SafetyModeration', 'TravelerMarks',
    'SimInventory', 'WeatherEcology', 'KnowledgeGraph',
    'ReputationLedger', 'WorldChronicle', 'CraftingChains',
    'LivingCalendar',
