...
var EXPECTED_MODULES = [
  ...
  'async_collab.js', 'economy_simulator.js', 'narrative_threads.js',
  'minigame_forge.js', 'multiverse_reputation.js', 'npc_delegation.js',
  'radio_station.js', 'seasonal_events_auto.js', 'event_consequences.js',
  'player_onboarding.js',
  'skill_mastery.js', 'world_shaper.js', 'trust_bonds.js',
  'recovery_system.js', 'bounty_board.js', 'market_signals.js',
  'consequence_branching.js', 'diplomatic_system.js',
  'merchant_guilds.js', 'grief_recovery.js',
  'anchor_management.js', 'community_board.js', 'constitution_amendments.js',
  'lore_discovery.js', 'spectator_system.js', 'warmth_system.js', 'zone_stewards.js',
